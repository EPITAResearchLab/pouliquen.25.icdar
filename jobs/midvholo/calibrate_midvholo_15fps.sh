time python3 calibration.py --config-name=midv_baseline -m "+experiment=joblib" "paths.split_name=k0,k1,k2,k3,k4" "model.t=40" "model.s_t=30" "decision.th=0.01" "decision=allvideo"
